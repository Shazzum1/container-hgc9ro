...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hgc9ro.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hgc9ro.containers.anotherwebservice.com/
...
```
git clone git@github.com:Shazzum1/container-hgc9ro.git
cd container-hgc9ro
```
...
```
docker attach container-hgc9ro
```
